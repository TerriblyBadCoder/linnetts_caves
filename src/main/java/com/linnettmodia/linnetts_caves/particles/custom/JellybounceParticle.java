...
public class JellybounceParticle extends TextureSheetParticle {
    ...
    JellybounceParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, int pDelay) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            return new JellybounceParticle(level, x, y, z, this.sprites, 0);
        }
    }
}
